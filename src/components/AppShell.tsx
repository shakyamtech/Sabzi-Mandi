        ...
        <div className="flex min-h-screen bg-background">
            <aside className="hidden md:flex w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
                ...
                <div className="p-3 border-t border-sidebar-border mt-auto">
                    <div className="px-3 py-2 text-[10px] font-bold text-sidebar-foreground/30 uppercase tracking-widest">Version 1.1.0</div>
                    <Button
                        variant="ghost"
                    ...
                    <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                        ...
                        <SheetContent side="left" className="w-[85%] max-w-[300px] p-0 bg-sidebar border-r-sidebar-border flex flex-col [&>button]:text-white [&>button]:opacity-70 hover:[&>button]:opacity-100">
                            ...
                            <div className="p-6 border-t border-sidebar-border mt-auto">
                                <div className="px-1 mb-4 text-[10px] font-bold text-sidebar-foreground/30 uppercase tracking-widest">Version 1.1.0</div>
